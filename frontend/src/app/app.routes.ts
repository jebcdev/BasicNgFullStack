...
import {NotAuthenticatedGuard,IsAuthenticatedGuard, IsAdminGuard} from '@shared/guards/';

export const appRoutes: Routes = [
  {canMatch:[NotAuthenticatedGuard], path: 'auth', loadChildren: () => import('@auth/routes/auth.routes') ,},
  {canMatch:[IsAdminGuard], path: 'admin', loadChildren: () => import('@admin/routes/admin.routes') ,},
